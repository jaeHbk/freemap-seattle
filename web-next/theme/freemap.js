 ...
 * Generated: 2026-07-27T19:21:30.866Z
 */

/**
 * freemap theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { freemapTheme } from './freemap';
 *   import './freemap.css';
 */
export const freemapTheme = {
  name: 'freemap',
  __built: true,
  tokens: {
    ...
    "--font-family-body": "var(--font-sans), -apple-system, BlinkMacSystemFont, \"Segoe UI\", sans-serif",
    "--font-family-heading": "var(--font-sans), -apple-system, BlinkMacSystemFont, \"Segoe UI\", sans-serif",
    ...
    "--color-background-surface": "light-dark(#FFFFFF, #202723)",
    "--color-background-body": "light-dark(#F7F8F5, #171C19)",
    "--color-background-card": "light-dark(#FFFFFF, #1B211E)",
    "--color-background-popover": "light-dark(#FFFFFF, #1B211E)",
    "--color-background-muted": "light-dark(#EEF1ED, #202723)",
    "--color-accent": "light-dark(#0D7A50, #51C28B)",
    "--color-accent-muted": "light-dark(#E3F2EB, #1C3D30)",
    ...
    "--color-text-primary": "light-dark(#19221E, #F4F7F5)",
    "--color-text-secondary": "light-dark(#5F6B65, #AAB5AF)",
    "--color-text-disabled": "light-dark(#a3a3a3, #525252)",
    "--color-text-accent": "light-dark(#0B6D47, #7AD8A7)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#171717",
    "--color-on-accent": "light-dark(#FFFFFF, #10251B)",
    "--color-on-success": "light-dark(#ffffff, #171717)",
    "--color-on-error": "light-dark(#ffffff, #171717)",
    "--color-on-warning": "#171717",
    "--color-icon-accent": "light-dark(#0D7A50, #7AD8A7)",
    "--color-icon-primary": "light-dark(#19221E, #F4F7F5)",
    "--color-icon-secondary": "light-dark(#68756E, #AAB5AF)",
    ...
    "--color-border": "light-dark(#DDE3DF, #FFFFFF1F)",
    "--color-border-emphasized": "light-dark(#B9C5BE, #65726B)",
