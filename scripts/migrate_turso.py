...
db/deals.db on its own. This script also creates candidate/evidence tables and
applies additive provenance and scrape-telemetry columns to an existing Turso
database.
"""
import os
import sys
